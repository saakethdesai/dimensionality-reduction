...
os.chdir(cwd)
ae.load_state_dict(torch.load("ae_at_epoch500.pth", map_location=torch.device('cpu')))
...
#np.save("/qscratch/ashriva/Experiments/Code/dim_reduction/results/pvd_1000_ae", data_recon)
