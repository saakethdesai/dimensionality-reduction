...
for i in range(test_data.shape[0]):
    if (counter < 100):
        ...
        data_recon = tmp_data_recon[i].reshape((512, 512))
        #plotting 
...
#save z and recon
np.save("spd_100_pca", tmp_data_recon)
np.save("spd_100_pca_z", tmp_data)

#save eigenvectors and eigenvalues
np.save("spd_100_pca_eigenvec", pca_model.components_)
np.save("spd_100_pca_eigenval", pca_model.explained_variance_)
