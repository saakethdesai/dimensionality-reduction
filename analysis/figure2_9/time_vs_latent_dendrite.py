...
basis_path2 = "/qscratch/saadesa/dimensionality_reduction/results_for_unshuffled_data/dendrite/"
...
for n in range(len(start)-1):
    ...
    # --------------------------------------------------------------------------------
    # DMAPS
    z_dmaps = np.load(basis_path+"/dendrite_dmaps_z.npy")
    ...
    # PCA
    z_pca = np.load(basis_path+"dendrite_"+str(PCA_NDim)+"_pca_z.npy")
    ...
    # AE
    z_ae = np.loadtxt(basis_path2+"AE/dendrite_"+str(AE_Ndim)+"_ae_latent_space.txt")
