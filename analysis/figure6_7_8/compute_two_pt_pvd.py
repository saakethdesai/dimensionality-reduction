...
DMAPS_LATENT_TYPE = 1000
hdffile = DATA_DIR+ "pvd_data.h5"
image_size = 256

hf = h5py.File(hdffile, 'r')
image_ae = np.load(RECON_DIR + DATA_type + "_" + str(AE_LATENT_TYPE) + "_ae.npy")
image_pca = np.load(RECON_DIR + DATA_type + "_" + str(PCA_LATENT_TYPE) + "_pca.npy")
image_dmaps = np.load(RECON_DIR + DATA_type + "_" + str(DMAPS_LATENT_TYPE) + "_dmaps.npy")[:1911]
image_gt = hf['test'][:]
...
# for index in range(500):
    ...
    # sub5.scatter(r[peaks], rdf_gt[peaks], marker="*",s=100, color='black', zorder=1)
    print(r[peaks])
    ...
    # sub5.scatter(r[peaks], rdf_ae[peaks], marker="*",s=100, color='black', zorder=1)
    print(r[peaks])
    ...
    # sub5.scatter(r[peaks], rdf_pca[peaks], marker="*",s=100, color='black', zorder=1)
    print(r[peaks])
    ...
    # sub5.scatter(r[peaks], rdf_dmaps[peaks], marker="*",s=100, color='black', zorder=1)
    print(r[peaks])
